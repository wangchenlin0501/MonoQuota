...
一款简洁的 macOS 菜单栏应用，以两排显示 Codex **5 小时和周额度的剩余百分比**。点击菜单栏项后，5h 和 Week 可以分别选择「仅数字」「进度条 + 数字」或「仅进度条」。支持手动刷新，每 60 秒自动更新。
...
点击菜单栏项，在「5h 显示方式」和「Week 显示方式」中分别设置两排。选择会保存在本机偏好设置中。
